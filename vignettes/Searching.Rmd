...
rlist's built-in functions `anyLike(dist,...)` and `allLike(dist,...)` that internally call `stringdist::ain` and `stringdist::stringdist` handle fuzzy searching to meet a wide range of demands. 
